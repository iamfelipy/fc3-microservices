...
/*
O fluxo típico da interface é:
Registrar os repositórios com Register.
Iniciar uma operação transacional com Do, passando uma função de trabalho.
Dentro da função, obter repositórios necessários via GetRepository.
Em caso de erro, chamar Rollback (ou deixar o próprio Do gerenciar).
Se tudo OK, finalizar transação com CommitOrRollback.
Opcionalmente, remover repositórios com UnRegister.
*/
