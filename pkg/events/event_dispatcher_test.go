...
type EventDispatcherTestSuite struct {
	// suite.Suite está sendo embutido (embedded) na struct EventDispatcherTestSuite para herdar métodos e funcionalidades do pacote testify, facilitando a escrita de testes em Go.
	suite.Suite
	event           TestEvent
	event2          TestEvent
...
// testify reconhece e chama por que tem o prefixo Test
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Register() {
	// Porque enviar suite.T()? fornece o contexto do teste para que o testify registre falhas corretamente.
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Dispatch() {
	...
	// isso verifica se o spy dos mocks foram chamados
